...
# -------   1.	Create a list of unique club for this dataset. Then, create a dictionary to show how many players each
# club has.\
...
for item in dictionay_club_with_age_of_player:
    ...
    for raw_data in data:
        if item == raw_data[1]:
            dictionay_club_with_age_of_player[item][0] = dictionay_club_with_age_of_player[item][0] + int(
                raw_data[2])  # total_age
            ...
            dictionay_club_with_age_of_player[item][3] = dictionay_club_with_age_of_player[item][3] + float(
                raw_data[5])  # market_value
